...
date
echo ""
echo "Removing (*)_heads_export.dat files and feflow_runs.log from last run"
rm -f /home/axa/feflow_files/import+export/*t.*
rm -f /home/axa/feflow_files/feflow_runs.log
...
for ((x=1 ; x<=model_count; x++ )); do
	...
	args="-log feflow_runs.log -work /home/axa/feflow_files $x.fem"
	feflow70c $args 
	echo""
